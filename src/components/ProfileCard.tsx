...
export default async function ProfileCard({params, token}:{params:{id:string}, token:string}) { 
  ...
  <div className='flex flex-col bg-white w-[800px] h-[600px] justify-center items-center shadow-lg rounded-2xl gap-5'>
    ...
    <div className='flex flex-col w-[550px] gap-8'>
      ...
      <div className=' flex flex-col gap-3 text-lg '>
        ...
        {/* not finished yet */}
        <MakeApptDialog dentists={dentists_and_default} token={token}></MakeApptDialog>
      </div>
    </div>
  </div>
);
